...
import { submitBooking } from "@/app/lessons/actions"
import type { BookingState } from "@/lib/booking-schema"

const fieldClass =
  "w-full rounded-xl border border-border bg-background px-4 py-2.5 text-sm text-foreground shadow-sm outline-none transition-colors placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40 aria-[invalid=true]:border-destructive aria-[invalid=true]:ring-2 aria-[invalid=true]:ring-destructive/30"
          ...
          <form ref={formRef} action={formAction} className="flex flex-col gap-5" noValidate>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div>
                ...
                {errors.ageGroup ? (
                  <p id="ageGroup-error" className={errorClass}>
                    {errors.ageGroup}
                  </p>
                ) : null}
              </div>
              <div>
                ...
                {errors.experienceLevel ? (
                  <p id="experienceLevel-error" className={errorClass}>
                    {errors.experienceLevel}
                  </p>
                ) : null}
              </div>
              ...
              <div>
                <label htmlFor="numberOfRiders" className={labelClass}>
                  Number of Riders
                </label>
                <input
                  id="numberOfRiders"
